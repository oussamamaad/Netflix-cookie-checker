...
{Fore.YELLOW}      Cookie Checker — https://github.com/oussamamaad/Netflix-cookie-checker
{Style.RESET_ALL}"""
    ...
    try:
        ...
        with requests.Session() as session:
            if open_webpage_with_cookies(session, url, cookies, filename):
                meta = {
                    "_comment": "Cookie checked by https://github.com/oussamamaad/Netflix-cookie-checker",
                    "Credits": "Matheesha Pathirana",
                    "Discord Server": "https://discord.gg/blueeye",
